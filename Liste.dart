...
class MyData extends DataTableSource {
  final List<Map<String, dynamic>> _data = List.generate(
      ...
      (index) => {
            ...
            "Etats(vente/achat)": SelectionContainer,
          });
  ...
  DataRow? getRow(int index) {
    return DataRow(cells: [
      ...
      DataCell(Text(_data[index]["libellé"].toString())),
      DataCell(Text(_data[index]["prix de vente"].toString())),
      DataCell(Text(_data[index]["prix d'achat"].toString())),
      DataCell(Text(_data[index]["Etats(vente/achat)"].toString())),
    ]);
  }
